                        ...
                        <Box className="register_form_box">
                            ...
                            {/* <Box className="register_page_fields">
                                ...
                                <Autocomplete
                                    ...
                                    getOptionLabel={option => option.name}
                                    onChange={(e, value) => {
                                        setRegisterData({ ...registerData, city: value })
                                    }}
                                    renderInput={params => (
                            ...
                            {/* <Box className="register_page_fields">
                                <Box>
                                    <InputLabel>SkypeId</InputLabel>
                                    <TextField
                                        className="register_input_fields"
                                        label="SkypeId"
                                        placeholder="SkypeId"
                                        value={registerData?.skypeId}
                                        onChange={e => {
                                            setRegisterData({ ...registerData, skypeId: e.target.value })
                                        }}
                                        variant="outlined"
                                    />
                                </Box>
                            ...
                            {/* <Box className="register_page_fields">
                                <TextField
                                    ...
                                    value={registerData?.githubProfile}
                                    onChange={e => {
                                        setRegisterData({ ...registerData, githubProfile: e.target.value })
                                    }}
                                    variant="outlined"
                                />
                                <TextField
                                    ...
                                    type={'text'}
                                    value={registerData?.freelancerProfile}
                                    onChange={e => {
                                        setRegisterData({ ...registerData, freelancerProfile: e.target.value })
                                    }}
                                />
                            </Box> */}
                            {/* <Box className="register_page_fields">
                                <TextField
                                    ...
                                    onChange={e => {
                                        setRegisterData({ ...registerData, hourlyRate: e.target.value })
                                    }}
                                    variant="outlined"
                                />
                                <FormControl>
                                    ...
                                    <Select
                                        ...
                                        value={registerData?.englishLevel}
                                        onChange={e => {
                                            setRegisterData({ ...registerData, englishLevel: e.target.value })
                                        }}
                                    >
